...
# A polymorphic function that works for any ShoppingCart type
...
if __name__ == "__main__":
    ...
    print(">>> Ordinary Cart With Tax & Discount <<<")
    checkout(obj_cart)

    # 2) Applying Discount
    disc_cart = DicountedCart(discount_rate=0.15)  # 15% discount
    ...
    checkout(disc_cart)  # <-- Prints discounted cart
    ...
    checkout(taxed_cart)  # <-- Prints taxed cart
